...
def main(p, T, Td, station_height, lat):
    """
    Calculate the reduced pressure using the barometric height formula.
    """
    ...
    print(u'Reduced pressure for station: h = %s m lat = %s ° is: p_red = %s hPa' % (station_height, lat, p_red))
    return p_red
